...
export const ASSUMPTION_DEFS: AssumptionDef[] = [
  ...
  { key: "mezzanine_amount", label: "Mezzanine Debt Amount", category: "Capital Stack", unit: "$", numeric: true, required: false,
    aliases: ["mezzanine amount","mezz debt","mezzanine loan","subordinate debt","junior debt"] },
  { key: "mezzanine_interest_rate", label: "Mezzanine Interest Rate", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["mezzanine interest rate","mezz rate","mezzanine coupon","junior debt rate"] },
  { key: "mezzanine_amortization_years", label: "Mezzanine Amortization", category: "Capital Stack", unit: "yr", numeric: true, required: false,
    aliases: ["mezzanine amortization","mezz amortization","mezz amort term"] },
  { key: "mezzanine_io_months", label: "Mezzanine Interest-Only Period", category: "Capital Stack", unit: "mo", numeric: true, required: false,
    aliases: ["mezzanine interest-only","mezz io","mezzanine io months"] },
  { key: "lp_equity_split", label: "LP Equity Share", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["lp equity split","lp equity share","limited partner equity","investor equity share"] },
  { key: "preferred_return", label: "LP Preferred Return", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["preferred return","lp preferred return","preferred return hurdle","pref"] },
  { key: "gp_catch_up", label: "GP Catch-Up Enabled", category: "Capital Stack", unit: "count", numeric: true, required: false,
    aliases: ["gp catch-up","gp catch up","catch-up enabled"] },
  { key: "promote_tier_1_hurdle", label: "Promote Tier 1 Hurdle", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["tier 1 hurdle","first promote hurdle","promote hurdle"] },
  { key: "promote_tier_1_gp_split", label: "Promote Tier 1 GP Split", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["tier 1 gp split","first promote split","gp promote split"] },
  { key: "promote_tier_2_hurdle", label: "Promote Tier 2 Hurdle", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["tier 2 hurdle","second promote hurdle"] },
  { key: "promote_tier_2_gp_split", label: "Promote Tier 2 GP Split", category: "Capital Stack", unit: "%", numeric: true, required: false,
    aliases: ["tier 2 gp split","second promote split"] },
  { key: "phase_equity_draws", label: "Phase Equity Draws", category: "Schedule", unit: "count", numeric: true, required: false,
    aliases: ["phase equity draws","equity draw timing","monthly equity draws","straight-line equity draws"] },
