...
export const en = {
  ...
  "dash.total": "total",
  "dash.grossPipeline": "Gross pipeline",
  "dash.weighted": "weighted",
  "dash.avgScore": "Avg investment score",
  "dash.velocity": "Pipeline velocity",
  "dash.elevatedRisk": "Elevated risk",
  "dash.needReview": "need review",
  "dash.pipelineFlow": "Pipeline flow",
  "dash.manage": "Manage",
  "dash.upcomingDates": "Upcoming dates",
  "dash.overdueShort": "overdue",
  "dash.addTargetDates": "Add target dates to deals to track deadlines here.",
  "dash.topOpportunities": "Top opportunities",
  "dash.confidence": "Confidence",
  "dash.score": "Score",
  "dash.opportunitiesRank": "Opportunities will rank after underwriting is complete.",
  "dash.priorityInsights": "Priority insights",

  // ---- Committee ----
  "page.committee.eyebrow": "Decision",
  "page.committee.subtitle":
    "Recommendation, conditions, and the recorded decision: with a permanent audit trail.",
  "committee.empty": "No deals to bring to committee yet.",

  // ---- Deals ----
  "deals.subtitle": "{count} deals across the underwriting pipeline",
  "deals.seedDemo": "Seed demo deal",
  "deals.seeding": "Seeding…",
  "deals.searchPlaceholder": "Search deals, markets, sources…",
  "deals.sort": "Sort",
  "deals.sortBy": "Sort by",
  "deals.columns": "Columns",
  "deals.visibleColumns": "Visible columns",
  "deals.resetColumns": "Reset columns",
  "deals.views": "Views",
  "deals.savedViews": "Saved views",
  "deals.noSavedViews": "No saved views yet",
  "deals.saveCurrentView": "Save current view…",
  "deals.resetToDefault": "Reset to default",
  "deals.selected": "{count} selected",
  "deals.setPipelineStatus": "Set pipeline status…",
  "deals.emptyList": "No deals here. Seed the Harbour Centre demo or create a new deal.",
  "deals.saveViewTitle": "Save current view",
  "deals.viewName": "View name",
  "deals.viewNamePlaceholder": "e.g. Office deals, near close",
  "deals.saveView": "Save view",
} as const;
...
export const fr: Partial<Record<TranslationKey, string>> = {
  ...
  "dash.total": "au total",
  "dash.grossPipeline": "Capital total",
  "dash.weighted": "pondéré",
  "dash.avgScore": "Score moyen",
  "dash.velocity": "Vélocité",
  "dash.elevatedRisk": "Risque élevé",
  "dash.needReview": "à examiner",
  "dash.pipelineFlow": "Flux du pipeline",
  "dash.manage": "Gérer",
  "dash.upcomingDates": "Prochaines dates",
  "dash.overdueShort": "en retard",
  "dash.addTargetDates": "Ajoutez des dates cibles aux affaires pour suivre les échéances ici.",
  "dash.topOpportunities": "Meilleures opportunités",
  "dash.confidence": "Confiance",
  "dash.score": "Score",
  "dash.opportunitiesRank": "Les opportunités seront classées une fois l’analyse terminée.",
  "dash.priorityInsights": "Aperçus prioritaires",

  "page.committee.eyebrow": "Décision",
  "page.committee.subtitle":
    "Recommandation, conditions et décision consignée : avec une piste d’audit permanente.",
  "committee.empty": "Aucune affaire à présenter au comité pour l’instant.",

  "deals.subtitle": "{count} affaires dans le pipeline d’analyse",
  "deals.seedDemo": "Charger la démo",
  "deals.seeding": "Chargement…",
  "deals.searchPlaceholder": "Rechercher affaires, marchés, sources…",
  "deals.sort": "Trier",
  "deals.sortBy": "Trier par",
  "deals.columns": "Colonnes",
  "deals.visibleColumns": "Colonnes visibles",
  "deals.resetColumns": "Réinitialiser les colonnes",
  "deals.views": "Vues",
  "deals.savedViews": "Vues enregistrées",
  "deals.noSavedViews": "Aucune vue enregistrée",
  "deals.saveCurrentView": "Enregistrer la vue actuelle…",
  "deals.resetToDefault": "Réinitialiser par défaut",
  "deals.selected": "{count} sélectionnée(s)",
  "deals.setPipelineStatus": "Définir le statut du pipeline…",
  "deals.emptyList":
    "Aucune affaire ici. Chargez la démo Harbour Centre ou créez une nouvelle affaire.",
  "deals.saveViewTitle": "Enregistrer la vue actuelle",
  "deals.viewName": "Nom de la vue",
  "deals.viewNamePlaceholder": "p. ex. Bureaux, proches de la clôture",
  "deals.saveView": "Enregistrer la vue",
};
