...
function report() {
  const assumptions = [
    ...
    },
    {
      field_key: "min_dscr",
      value_numeric: 1.2,
      field_label: "Minimum DSCR Covenant",
      unit: "x",
      status: "approved",
      source_document_id: "doc-lender",
    },
  ...
  const flags = [
    {
      ...
      severity: "error",
      message: "requires NOI 14,407,782 (1.20x × ADS): fails by 2.4×.",
      expected: 14_407_782,
      actual: 6_395_155,
      resolved: false,
    },
    {
      ...
      severity: "error",
      message: "equity + debt → $37,500,000 short.",
    ...
    },
    {
      ...
      severity: "warning",
      message: "Office occupancy 85.0% is below 93.0%.",
      expected: 93,
      actual: 85,
      resolved: false,
    },
  ...
  const risks = [
    {
      ...
      severity: "critical",
      description: "Equity wiped out (EM ≈ 0.0x, IRR not meaningful).",
    },
  ];
  const documents = [
  ...
  return buildMemoReport({
    ...
    assumptions,
    engineInputs: [{ key: "exit_cap_rate_pct", value_numeric: 5.25, status: "approved" }],
    outputs,
    flags,
    risks,
    documents,
